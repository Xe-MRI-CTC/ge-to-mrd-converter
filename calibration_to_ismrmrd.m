function calibration_to_ismrmrd(mrdfile,calfile)
%%
...
tmp = read_fdl('/user/iibi/anhahn/code/mns-xe/xe_calibration/calibration3D_129xe_fov400_nsp256_intlv600_kdt40_dur10p2cal_freq_208ppm.fdl');
freq_off = tmp(1); 
nDis = sum(tmp > 0); clear tmp;


tmp = read_fdl('/user/iibi/anhahn/code/mns-xe/xe_calibration/calibration3D_129xe_fov400_nsp256_intlv600_kdt40_dur10p2cal_TR.fdl');
